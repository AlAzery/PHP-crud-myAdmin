...
<div class="wrapper">
    ...
    <form action="" method="post" enctype="multipart/form-data" accept-charset="utf-8">
       <div class="inputfield">
          <label>Name</label>
          <input type="text" class="input" name="nama" placeholder="name..."
          autocomplete="off">
       </div>  
        <div class="inputfield">
          <label>Alamat</label>
          <input type="text" class="input" name="alamat" placeholder="alamat..." autocomplete="off">
       </div>  
       <div class="inputfield">
          <label>Email</label>
      ...
      <div class="inputfield">
          <label>NO hp</label>
          <input type="number" class="input" name="number" placeholder="Number hp..." autocomplete="off">
       </div> 
      <div class="inputfield">
          <label>profil</label>
